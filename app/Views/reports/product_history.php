    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0"><i class="bi bi-box-seam me-2"></i>Sales History - <?= $product['product_name'] ?></h5>
            ...
            <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <div class="card bg-light">
                            <div class="card-body">
                                ...
                                <p class="mb-1"><strong>Name:</strong> <?= $product['product_name'] ?></p>
                                <p class="mb-1"><strong>SKU:</strong> <?= $product['sku'] ?></p>
                                <p class="mb-1"><strong>Current Stock:</strong> <?= $product['quantity'] ?> <?= $product['unit_name'] ?? '' ?></p>
                                <p class="mb-1"><strong>Purchase Price:</strong> <?= formatCurrency($product['purchase_price'], 'LRD') ?></p>
                                <p class="mb-1"><strong>Selling Price:</strong> <?= formatCurrency($product['selling_price'], 'LRD') ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card bg-light">
                            <div class="card-body">
                                ...
                                ?>
                                <p class="mb-1"><strong>Total Quantity Sold:</strong> <?= number_format($totalQuantity, 2) ?> <?= $product['unit_name'] ?? '' ?></p>
                                <p class="mb-1"><strong>Total Revenue:</strong> <?= formatCurrency($totalRevenue, 'LRD') ?></p>
                                <p class="mb-1"><strong>Transactions:</strong> <?= $totalTransactions ?></p>
                                <p class="mb-1"><strong>Average Price:</strong> <?= $totalQuantity > 0 ? formatCurrency($totalRevenue / $totalQuantity, 'LRD') : 'N/A' ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-sm sortable-table" id="productSalesTable">
                        <thead>
                            <tr>
                                ...
                                <th data-sort="float" class="text-end">Quantity</th>
                                <th data-sort="float" class="text-end">Unit Price</th>
                                <th data-sort="float" class="text-end">Total Price</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('sales/view/' . $sale['sale_id']) ?>" class="text-decoration-none">
                                        #<?= str_pad($sale['sale_id'], 6, '0', STR_PAD_LEFT) ?>
                                    </a>
                                </td>
                                <td>
                                ...
                                <td class="text-end">
                                    <?= number_format($sale['quantity'], 2) ?> <?= $product['unit_name'] ?? '' ?>
                                </td>
                                <td class="text-end">
                                ...
                                <td>
                                    <span class="badge bg-primary"><?= $sale['currency'] ?></span>
                                </td>
                                <td>
                                    <a href="<?= base_url('sales/view/' . $sale['sale_id']) ?>" class="btn btn-sm btn-outline-primary">
                ...
                <?php if (empty($sales)): ?>
                    <div class="text-center text-muted py-4">
                        ...
                        <p>No sales found for this product in the selected period.</p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
