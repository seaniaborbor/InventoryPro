    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0"><i class="bi bi-person me-2"></i>Purchase History - <?= $customer['customer_name'] ?></h5>
            ...
            <div class="card-body">
                ...
                <div class="row mb-4">
                        ...
                        <div class="card bg-light">
                            <div class="card-body">
                                ...
                                <?php if ($customer['business_name']): ?>
                                    <p class="mb-1"><strong>Business:</strong> <?= $customer['business_name'] ?></p>
                                <?php endif; ?>
                    ...
                    <div class="col-md-6">
                        <div class="card bg-light">
                            <div class="card-body">
                                <h6 class="card-title">Purchase Summary (<?= date('M Y', strtotime($startDate)) ?> - <?= date('M Y', strtotime($endDate)) ?>)</h6>
                                <?php
                                $totalLRD = 0;
                                $totalUSD = 0;
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-sm sortable-table" id="customerSalesTable">
                        <thead>
                            <tr>
...
$(document).ready(function() {
    ...
    const table = $('#customerSalesTable');
